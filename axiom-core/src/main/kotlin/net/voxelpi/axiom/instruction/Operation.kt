...
public enum class Operation(public val type: OperationType, public val format: String) {
    ...
    IO_POLL_1(OperationType.NO_INPUT_WITH_OUTPUT, "{out} = poll1"),
    IO_READ_1(OperationType.NO_INPUT_WITH_OUTPUT, "{out} = read1"),
    IO_WRITE_1(OperationType.A_INPUT_NO_OUTPUT, "write1 {a}"),
